<script>
	...
	import { MinValueValidation } from 'qei-input-validations/src/validations/MinValueValidation';
	import { MaxValueValidation } from 'qei-input-validations/src/validations/MaxValueValidation';
